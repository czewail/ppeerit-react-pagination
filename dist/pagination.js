...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/index.js!./paginate.less", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/less-loader/dist/index.js!./paginate.less");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
var Pagination = function (_React$Component) {
    ...
    function Pagination(props) {
        ...
        _this._hasPrev = function () {
            return _this.state.current > 1;
        };

        _this._hasNext = function () {
            return _this.state.current < _this._getPages();
        };

        _this._prev = function (e) {
            e.preventDefault();
            if (_this._hasPrev()) {
                _this._handleChange(_this.state.current - 1);
            }
        };

        _this._next = function (e) {
            e.preventDefault();
            if (_this._hasNext()) {
                _this._handleChange(_this.state.current + 1);
            }
        ...
        _this._jump = function (e, page) {
            e.preventDefault();
            if (page !== _this.state.current) {
                _this._handleChange(page);
            }
        };

        _this._handleChange = function (page) {
        ...
        _this._renderLessPagination = function (pages) {
            var pageList = [];
            pageList.push(_this._renderPrev());
            for (var i = 1; i <= pages; i++) {
                pageList.push(_this._renderPage(i));
            }
            pageList.push(_this._renderNext());
            return pageList;
        };

        _this._renderMorePagination = function (pages) {
            var pageList = [];
            var current = _this.state.current;

            pageList.push(_this._renderPrev());
            if (current >= 4 && current <= pages - 3) {
                pageList.push(_this._renderPage(1));
                pageList.push(_this._renderOmit('front'));
                for (var i = current - 1; i <= current + 1; i++) {
                    pageList.push(_this._renderPage(i));
                }
                pageList.push(_this._renderOmit('back'));
                pageList.push(_this._renderPage(pages));
            } else if (current < 4) {
                for (var _i = 1; _i <= 4; _i++) {
                    pageList.push(_this._renderPage(_i));
                }
                pageList.push(_this._renderOmit('back'));
                pageList.push(_this._renderPage(pages));
                ...
                pageList.push(_this._renderPage(1));
                pageList.push(_this._renderOmit('front'));
                for (var _i2 = pages - 3; _i2 <= pages; _i2++) {
                    pageList.push(_this._renderPage(_i2));
                }
            }
            pageList.push(_this._renderNext());
            return pageList;
        ...
        _this._renderPrev = function () {
            var prevDisable = !_this._hasPrev();
            return _react2.default.createElement(
                'li',
                { key: 'prev', onClick: _this._prev, className: (0, _classnames2.default)('prev', {
                        'disabled': prevDisable
                    }) },
                _react2.default.createElement(
                    'a',
                    { href: '#' },
                    _react2.default.createElement('i', { className: (0, _classnames2.default)('fa', 'fa-angle-left') })
                )
            );
        };

        _this._renderPage = function (page) {
            var current = _this.state.current;

            return _react2.default.createElement(
                'li',
                { key: page, onClick: function onClick(e) {
                        return _this._jump(e, page);
        ...
        _this._renderOmit = function (key) {
            return _react2.default.createElement(
                'li',
                { key: key, onClick: function onClick(e) {
                        return _this._jump(e, page);
                    }, className: (0, _classnames2.default)('disabled') },
                _react2.default.createElement(
                    'a',
                    { href: '#' },
                    '...'
        ...
        _this._renderNext = function () {
            var nextDisable = !_this._hasNext();
            return _react2.default.createElement(
                'li',
                { key: 'next', onClick: _this._next, className: (0, _classnames2.default)('next', {
                        'disabled': nextDisable
                    }) },
                _react2.default.createElement(
                    'a',
                    { href: '#' },
                    _react2.default.createElement('i', { className: (0, _classnames2.default)('fa', 'fa-angle-right') })
                )
            );
        };
    ...
    _createClass(Pagination, [{
        ...
        value: function render() {
            ...
            var paginationClassNames = (0, _classnames2.default)(className);
